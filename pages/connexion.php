...
if(isset($_POST["SeConnecter"]))
{
    ...
    include("init.php");
    $stid = oci_parse($conn, "select TYPE_USA, LOGIN_USAGER, NOM_ORGANISME, NOM_USA, PRENOM_USA from TP2_USAGER where LOGIN_USAGER = :login_user and MOT_DE_PASSE_USA=:login_password ");
    ...
    while (($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) != false) {
       $_SESSION['TYPE_USA']= $row["TYPE_USA"];
        ...
        $_SESSION['NOM_USA']= $row["NOM_USA"];
        $_SESSION['PRENOM_USA']=$row["PRENOM_USA"];
